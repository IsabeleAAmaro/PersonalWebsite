...
export default function Experiences() {
  ...
  const experiences = [
    {
      title: "Estágiaria de Desenvolvimento, BNDES",
    ...
    {
      title: "Pesquisadora Júnior em Ciências da Saúde e Engenharia de Software, Universidade Federal do Estado do Rio de Janeiro",
          ...
          <div className="space-y-4">
            {experiences.map((exp, index) => (
                <div key={index} className="max-w-xl">
                  <h3 className="font-medium text-[20px]">{exp.title}</h3>
